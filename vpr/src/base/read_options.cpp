...
struct ParseOnOff {
    ConvertedValue<bool> from_str(std::string str) {
        ...
        if (str == "on")
            ...
            msg << "Invalid conversion from '" << str << "' to boolean (expected one of: "
...
struct ParseArchFormat {
    ConvertedValue<e_arch_format> from_str(const std::string& str) {
        ...
        if (str == "vtr")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_arch_format (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseCircuitFormat {
    ConvertedValue<e_circuit_format> from_str(const std::string& str) {
        ...
        if (str == "auto")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_circuit_format (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseRoutePredictor {
    ConvertedValue<e_routing_failure_predictor> from_str(const std::string& str) {
        ...
        if (str == "safe")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_routing_failure_predictor (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseRouterAlgorithm {
    ConvertedValue<e_router_algorithm> from_str(const std::string& str) {
        ...
        if (str == "parallel")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_router_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseNodeReorderAlgorithm {
    ConvertedValue<e_rr_node_reorder_algorithm> from_str(const std::string& str) {
        ...
        if (str == "none")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_rr_node_reorder_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct RouteBudgetsAlgorithm {
    ConvertedValue<e_routing_budgets_algorithm> from_str(const std::string& str) {
        ...
        if (str == "minimax")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_routing_budget_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
...
struct ParseBaseCost {
    ...
    std::vector<std::string> default_choices() {
        return {"demand_only", "demand_only_normalized_length", "delay_normalized", "delay_normalized_length",
                "delay_normalized_length_bounded", "delay_normalized_frequency", "delay_normalized_length_frequency"};
    }
};
...
struct ParsePlaceDeltaDelayAlgorithm {
    ConvertedValue<e_place_delta_delay_algorithm> from_str(const std::string& str) {
        ...
        if (str == "astar")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_place_delta_delay_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParsePlaceAlgorithm {
    ConvertedValue<e_place_algorithm> from_str(const std::string& str) {
        ...
        if (str == "bounding_box") {
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_place_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
...
struct ParsePlaceAgentAlgorithm {
    ConvertedValue<e_agent_algorithm> from_str(const std::string& str) {
        ...
        if (str == "e_greedy")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_agent_algorithm (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParsePlaceAgentSpace {
    ConvertedValue<e_agent_space> from_str(const std::string& str) {
        ...
        if (str == "move_type")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_agent_space (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseConstantNetMethod {
    ConvertedValue<e_constant_net_method> from_str(const std::string& str) {
        ...
        if (str == "global")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_constant_net_method (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseTimingReportDetail {
    ConvertedValue<e_timing_report_detail> from_str(const std::string& str) {
        ...
        if (str == "netlist")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_timing_report_detail (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParsePlaceDelayModel {
    ConvertedValue<PlaceDelayModelType> from_str(const std::string& str) {
        ...
        if (str == "simple") {
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to PlaceDelayModelType (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseReducer {
    ConvertedValue<e_reducer> from_str(const std::string& str) {
        ...
        if (str == "min")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_reducer (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseRouterFirstIterTiming {
    ConvertedValue<e_router_initial_timing> from_str(const std::string& str) {
        ...
        if (str == "all_critical")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_router_initial_timing (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseRouterHeap {
    ConvertedValue<e_heap_type> from_str(const std::string& str) {
        ...
        if (str == "binary")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_heap_type (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseCheckRoute {
    ConvertedValue<e_check_route_option> from_str(const std::string& str) {
        ...
        if (str == "off")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_check_route_option (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParsePlaceEfforScaling {
    ConvertedValue<e_place_effort_scaling> from_str(const std::string& str) {
        ...
        if (str == "circuit")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_place_effort_scaling (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParseTimingUpdateType {
    ConvertedValue<e_timing_update_type> from_str(const std::string& str) {
        ...
        if (str == "auto")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_timing_update_type (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
...
struct ParsePostSynthNetlistUnconnInputHandling {
    ConvertedValue<e_post_synth_netlist_unconn_handling> from_str(const std::string& str) {
        ...
        if (str == "unconnected")
            ...
            std::stringstream msg;
            msg << "Invalid conversion from '" << str << "' to e_post_synth_netlist_unconn_handling (expected one of: "
                << argparse::join(default_choices(), ", ") << ")";
            conv_value.set_error(msg.str());
        }
        return conv_value;
