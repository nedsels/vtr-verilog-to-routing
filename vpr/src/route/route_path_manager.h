...
class PathManager {
  public:
    ...
    void insert_backwards_path_into_traceback(t_heap_path* path_data, float cost, float backward_path_cost, float backward_path_delay, float backward_path_congestion, RoutingContext& route_ctx);
